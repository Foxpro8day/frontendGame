import MiniGamePopup from "../assets/images/8day-Minigame-Icon-2.png";
...
const XocdiaLogo = (props) => {
  const logoXocdia = { x: 229, y: 270, width: 137, height: 113 };
...
const BaucuaLogo = (props) => {
  const logoBaucua = { x: 40, y: 275, width: 145, height: 110 };
...
const LodeLogo = (props) => {
  const logoBaucua = { x: 220, y: 400, width: 145, height: 120 };
...
const PokerLogo = (props) => {
  const logoBaucua = { x: 35, y: 400, width: 145, height: 120 };
