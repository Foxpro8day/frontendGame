...
const Minigame = () => {
  ...
  return (
    <>
      ...
      <img
        src="wp-content/uploads/2025/01/Speaker_Icon.svg.png"
        style="width: 30px"
      />
      <marquee>
        Tham gia với hàng ngàn phần thưởng hấp dẫn như : Thưởng nạp lần đầu lên
        đến <strong>8,888k</strong>, Giới thiệu người chơi nhận thưởng mỗi ngày
        , Mở sổ tiết kiệm lợi tức <strong>88% </strong> , Hoàn trả tức thời
        không giới hạn <strong>2%</strong>
      </marquee>
    </>
  );
};
